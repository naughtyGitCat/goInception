...
var tokenMap = map[string]int{
	...
	"ELSEIF":                          elseIfKwd,
	"ENABLE":                          enable,
	"ENABLE_MACRO_BLOCK_BLOOM_FILTER": enableMacroBlockBloomFilter,
	"ENCLOSED":                        enclosed,
	"END":                      end,
	"ENFORCED":                 enforced,
	"ENGINE":                   engine,
	...
	"RETURN":                   returnKwd,
	"REWRITE":                  rewrite,
	"RETURNED_SQLSTATE":        returnedSqlstate,
	"RIGHT":                    right,
	"RLIKE":                    rlike,
	"ROLLBACK":                 rollback,
	"ROLLUP":                   rollup,
	...
	"SIMPLE":                   simple,
	"SKIP":                     skip,
	"SKIP_INDEX_LEVEL":         skipIndexLevel,
	"SIGNED":                   signed,
	"SLAVE":                    slave,
	"SLOW":                     slow,
	...
	"SCHEMA_NAME":              schemaNameKwd,
	"TABLE":                    tableKwd,
	"TABLE_NAME":               tableNameKwd,
	...
	"USAGE":                    usage,
	"USE":                      use,
	"USE_BLOOM_FILTER":         useBloomFilter,
	"USER":                     user,
	"USING":                    using,
	"UTC_DATE":                 utcDate,
	"UTC_TIME":                 utcTime,
